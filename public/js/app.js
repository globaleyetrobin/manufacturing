$(document).ready(function() {
    ...
    // Start Materials Crud
	
	 var materials_table = $('#materials_table').DataTable({
        processing: true,
        serverSide: true,
        ajax: '/manufacturing/materialslist',
        columnDefs: [
            {
                targets: 4,
                orderable: false,
	    ...
	    $(document).on('click', 'button.edit_materials_button', function() {
        $('div.materials_modal').load($(this).data('href'), function() {
            $(this).modal('show');
	...
	//delete_materials_button
	
	
	
	
	    $(document).on('click', 'button.delete_materials_button', function() {
        swal({
            title: LANG.sure,
	...
	var manufactureorder_table = $('#manufactureorder_table').DataTable({
        processing: true,
        serverSide: true,
        ajax: '/manufacturing/orderlist',
        columnDefs: [
            {
                targets: 10,
                orderable: false,
		...
		$(document).on('click', 'button.delete_orders_button', function() {
        swal({
            title: LANG.sure,
            text: 'Are you confirm to delete',
            icon: 'warning',
            ...
            if (willDelete) {
                ...
                $.ajax({
                    ...
                    success: function(result) {
                        if (result.success === true) {
                            toastr.success(result.msg);
                            manufactureorder_table.ajax.reload();
                        } else {
                            toastr.error(result.msg);
                        }
                    },
	...
	// End Manufacturing Order Code
	
	//productdetails table productdetailsedit
	
		var productdetails_table = $('#productdetails_table').DataTable({
        processing: true,
        serverSide: true,
        ajax: '/manufacturing/productdetailslist',
        columnDefs: [
            {
                targets: 3,
                orderable: false,
	...
	$(document).on('click', 'button.edit_productdetails_button', function() {
        $('div.productdetails_modal').load($(this).data('href'), function() {
            $(this).modal('show');
	    ...
	    $(document).on('click', 'button.delete_productdetails_button', function() {
        swal({
            title: LANG.sure,
            text: 'Are you confirm to delete',
            icon: 'warning',
            ...
            if (willDelete) {
                ...
                $.ajax({
                    ...
                    success: function(result) {
                        if (result.success === true) {
                            toastr.success(result.msg);
                            productdetails_table.ajax.reload();
                        } else {
                            toastr.error(result.msg);
                        }
                    },
