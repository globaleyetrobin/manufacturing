@extends('layouts.app')
@section('title','Material Purchase')

@section('content')

<!-- Content Header (Page header) -->
<section class="content-header no-print">
    <h1>Material Purchase
        <small></small>
    </h1>
    <!-- <ol class="breadcrumb">
...
<section class="content no-print">
    ...
    @component('components.widget', ['class' => 'box-primary', 'title' => 'All Material Purchase'])
        @can('purchase.create')
            @slot('tool')
                <div class="box-tools">
                    <a class="btn btn-block btn-primary" href="{{action('ManufacturingController@materialpurchasecreate')}}">
