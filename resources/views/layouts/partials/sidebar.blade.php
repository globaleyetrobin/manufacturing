  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
		...
		<li class="treeview {{ in_array($request->segment(1), ['manufacturing','purchases']) ? 'active active-sub' : '' }}" id="tour_step4">
            <a href="#" id="tour_step4_menu"><i class="fa fa-cubes"></i> <span>Manufacturing</span>
              <span class="pull-right-container">
                <i class="fa fa-angle-left pull-right"></i>
              </span>
            </a>
            <ul class="treeview-menu">
                ...
                <li class="{{ $request->segment(1) == 'manufacturing' && $request->segment(2) == 'materials' ? 'active' : '' }}">
				<a href="{{action('ManufacturingController@materials')}}"><i class="fa fa-list"></i> Material List </a>
				</li>
				
				<li class="{{ ( $request->segment(1) == 'manufacturing' || $request->segment(1) == 'purchases' )  &&
				($request->segment(2) == 'materialpurchase' || $request->segment(2) == 'create') ? 'active' : '' }}">
				<a href="{{action('PurchaseController@index')}}"><i class="fa fa-list"></i> Material Purchase </a>
				</li>
				...
				<li class="{{ $request->segment(1) == 'manufacturing' && $request->segment(2) == 'orders' ? 'active' : '' }}">
				<a href="{{action('ManufacturingController@orders')}}"><i class="fa fa-list"></i> Manufacturing Order </a>
				</li>
          ...
          @if(in_array('account', $enabled_modules))
            <li class="treeview {{ $request->segment(1) == 'account' ? 'active active-sub' : '' }}">
              ...
              <ul class="treeview-menu">
			     ...
			     <li class="{{ $request->segment(1) == 'account' && $request->segment(2) == 'account-settings' ? 'active' : '' }}"><a href="{{action('AccountController@AccountSettings')}}"><i class="fa fa-file-text-o"></i>BalanceSheet Settings</a></li>
