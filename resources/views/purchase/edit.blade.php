...
<section class="content">
  ...
  <!-- addedbyrobin -->
			 ...
			 $purchase->barcode=0;
			 ?>
             <div  style="display:none" class="@if(!empty($default_purchase_status)) col-sm-4 @else col-sm-3 @endif">
              <div class="form-group">
                {!! Form::label('barcode','Barcode') !!}
                {!! Form::text('barcode', $purchase->barcode, ['class' => 'form-control', 'required']); !!}
              </div>
            </div>
            ...
            <div class="col-sm-8 col-sm-offset-2">
              <div class="form-group">
                <div class="input-group">
                  ...
                  {!! Form::text('search_product', null, ['class' => 'form-control mousetrap', 'id' => 'search_product', 'placeholder' =>'Enter Material Name/Code', 'autofocus']); !!}
                </div>
              </div>
            </div>
