		...
		<div class="row">
			...
			<div  style="display:none" class="@if(!empty($default_purchase_status)) col-sm-4 @else col-sm-3 @endif">
				<div class="form-group">
					...
					{!! Form::text('barcode', 0, ['class' => 'form-control']); !!}
				</div>
			</div>
			...
			<div class="col-sm-8 col-sm-offset-2">
				<div class="form-group">
					<div class="input-group">
						...
						{!! Form::text('search_product', null, ['class' => 'form-control mousetrap', 'id' => 'search_product', 'placeholder' => 'Material Name/ Code', 'autofocus']); !!}
					</div>
				</div>
			</div>
