...
Route::middleware(['IsInstalled', 'auth', 'SetSessionData', 'language', 'timezone'])->group(function () {
	...
	Route::post('/purchases/get_materialpurchase_entry_row', 'PurchaseController@getPurchaseMaterialEntryRow');
    ...
    Route::get('/purchases/print/{id}', 'PurchaseController@printInvoice');
	  ...
	  Route::get('/purchases/get_materials', 'PurchaseController@getMaterials');
	
	/* added by robin */
	
	Route::get('/purchases/track/{id}', 'PurchaseController@track');
	Route::post('/purchases/savetrack/{id}', 'PurchaseController@savetrack');
	
    Route::resource('purchases', 'PurchaseController');
	
	
	/* added for manufacture module */
	
	
	//Route::resource('manufacturing', 'ManufacturingController');
	Route::get('/manufacturing/materials', 'ManufacturingController@materials');
	
	Route::get('/manufacturing/materialdelete/{id}', 'ManufacturingController@materialdelete');
	
	
	Route::get('/manufacturing/materialedit/{id}', 'ManufacturingController@materialedit');
	
	Route::get('/manufacturing/materialslist', 'ManufacturingController@materialslist');
	
	Route::get('/manufacturing/materialscreate', 'ManufacturingController@materialscreate');
	
	//Route::get('/manufacturing/materialpurchase', 'ManufacturingController@materialpurchase');
	
	
	Route::get('/manufacturing/materialpurchase', 'PurchaseController@index');
	
	
	Route::get('/manufacturing/materialpurchasecreate', 'ManufacturingController@materialpurchasecreate');
	
	Route::get('/manufacturing/materialstock/{id}', 'ManufacturingController@materialstock');
	
	Route::get('/manufacturing/orders', 'ManufacturingController@orders');
	
	Route::get('/manufacturing/createorder', 'ManufacturingController@createorder');
	
	Route::get('/manufacturing/assignmaterials/{id}', 'ManufacturingController@assignmaterials');
	
	Route::get('/manufacturing/productiondetails/{id}', 'ManufacturingController@productiondetails');
	
	 Route::post('/purchases/get_materialspurchase_entry_row', 'PurchaseController@getmaterialsPurchaseEntryRow');
	 
	 Route::post('/manufacturing/materialstore', 'ManufacturingController@materialstore');
	 
	 Route::post('/manufacturing/materialassignstore', 'ManufacturingController@materialassignstore');
	 
	 Route::post('/manufacturing/productdetailsstore', 'ManufacturingController@productdetailsstore');
	 
	 
	 Route::get('/manufacturing/productdetailsedit/{id}', 'ManufacturingController@productdetailsedit');
	 
	  
	 
	 Route::post('/manufacturing/orderupdate/{id}', 'ManufacturingController@orderupdate');
	  
	 
	 Route::get('/manufacturing/ordersedit/{id}', 'ManufacturingController@ordersedit');
	 
	 
	 Route::delete('/manufacturing/ordersdelete/{id}', 'ManufacturingController@ordersdelete');
	...
	// Route::get('/manufacturing/productdetailsdelete/{id}', 'ManufacturingController@productdetailsdelete');
	 
	 
	 Route::post('/manufacturing/productdetailsupdate/{id}', 'ManufacturingController@productdetailsupdate');
	 
	 Route::delete('/manufacturing/productdetailsdelete/{id}', 'ManufacturingController@productdetailsdelete');
	 
	 
	Route::post('/manufacturing/materialupdate/{id}', 'ManufacturingController@materialupdate');
	 
	 Route::delete('/manufacturing/materialdelete/{id}', 'ManufacturingController@materialdelete');
	 
	 
	 
	 Route::post('/manufacturing/orderstore', 'ManufacturingController@orderstore');
	 Route::get('/manufacturing/orderlist', 'ManufacturingController@orderlist');
	 
	  Route::post('/manufacturing/savetopos', 'ManufacturingController@savetopos');
	
	 
	 Route::get('/manufacturing/productdetailslist', 'ManufacturingController@productdetailslist');
	  
	  
	
	//Route::resource('manufacturing', 'ManufacturingController'); 
	  
	/* end menu list for manufacture module  */
    ...
    Route::group(['prefix' => 'account'], function () {
		...
		Route::post('/account-settingsstore', 'AccountController@AccountSettingsStore');
